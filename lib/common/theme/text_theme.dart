...
class Themes {
  static final lightTextTheme = TextTheme(
    ...
    bodyMedium: GoogleFonts.notoSans(fontSize: 14.sp, color: Colors.white, fontWeight: FontWeight.w500),
    bodySmall: GoogleFonts.notoSans(fontSize: 12.sp, color: Colors.white, fontWeight: FontWeight.w400),
  );
  static final darkTextTheme = TextTheme(
    ...
    bodySmall: GoogleFonts.notoSans(fontSize: 12.sp, color: Colors.black, fontWeight: FontWeight.w400),
  );
}
