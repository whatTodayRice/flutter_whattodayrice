...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/MY_active.svg
  ...
  /// File path: assets/images/icon_댓글.svg
  SvgGenImage get iconSvg_ => const SvgGenImage('assets/images/icon_댓글.svg');

  /// File path: assets/images/icon_더보기.svg
