...
class _CommentSliverListState extends State<CommentSliverList> {
  ...
  final PagingController<int, Comment> commentPagingController = PagingController<int, Comment>(firstPageKey: 1);
        ...
        sliver: PagedSliverList<int, Comment>.separated(
          ...
          builderDelegate: PagedChildBuilderDelegate(
            ...
            itemBuilder: (context, comment, index) {
              return CommentItem(comment: comment, commentIndex: index);
            },
          ),
          separatorBuilder: (BuildContext context, int index) {
            return Container(
              ...
              decoration: const BoxDecoration(
                border: Border(bottom: BorderSide(color: AppColor.white1)),
              ),
            );
          },
        ),
