                ...
                Align(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      String formattedDate = DateFormat('MM-dd (E)', 'ko_KR')
                          .format(userAccessDate);
                          ...
                          builder: (context) => AlertDialog(
                            content: SizedBox(
                              ...
                              child: TableCalendar(
                                ...
                                firstDay:
                                    DateTime.parse(weeklyMeals.first!.date),
                                ...
                                onDaySelected: (selectedDay, focusedDay) {
                                  ...
                                  int pageIndex =
                                      weeklyMeals.indexWhere((meal) {
                                    DateTime mealDate =
                                        DateTime.parse(meal!.date);
                                    String formattedMealDate =
                                        DateFormat('MM-dd (E)', 'ko_KR')
                                            .format(mealDate);
                                    return formattedMealDate == formattedDate;
                                  ...
                                  ref
                                      .read(
                                          pageNavigationStateProvider.notifier)
