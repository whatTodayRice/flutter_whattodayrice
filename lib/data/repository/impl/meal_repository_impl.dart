...
@LazySingleton(as: DormitoryMealRepository)
class DormitoryMealRepositoryImpl implements DormitoryMealRepository {
  final HappyDormsMealRemoteDataSource happyDormsMealRemoteDataSource;

  const DormitoryMealRepositoryImpl({required this.happyDormsMealRemoteDataSource});

  @override
  Future<List<MealData>> fetchHappyMeals() async {
    final happyMealResponse = await happyDormsMealRemoteDataSource.fetchHappyMeals();
